...
$PAGE->set_url('/enrol/moderated/unenroluser.php', array('ue'=>$ueid, 'ifilter'=>$filter));
...
if ($confirm && confirm_sesskey()) {
    //Delete entry from entrol_moderated db table
    $record = $DB->get_record('enrol_moderated', array('userid'=>$user->id, 'courseid'=>$course->id));
    $DB->delete_records('enrol_moderated', array('id'=>$record->id)); 
